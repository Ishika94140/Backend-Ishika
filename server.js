...
app.get("/", (req, res) => {
  ...
  res.send(
    "<h1>Welcome to our API</h1><ul><li>Get all persons: [GET] http://localhost/persons/</li> <li>Get on person: [GET] http://localhost/person/:id</li><li>Delete a person: [DELETE] http://localhost/person/:id</li></ul>"
  );
});
